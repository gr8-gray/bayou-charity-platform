...
// GuidesPanel — licensed-guide listings (`guide_postings`); posting is meant
// for members with the 'guide' role advertising availability and rates.
//
// SIBLING ALERT: GuidesPanel, TripsPanel, GearPanel, ForumPanel and
